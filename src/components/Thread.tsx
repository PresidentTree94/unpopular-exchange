    ...
    <div className="box relative text-left @container">
      ...
      <div className="flex gap-2 justify-between @max-3xs:flex-col">
        <div className="flex gap-2">
          <p className="tag flex items-center justify-center gap-[0.1875rem] flex-1 @max-3xs:p-1">000<FontAwesomeIcon icon={faSquarePollVertical} className="!h-4"/></p>
          <p className="tag flex items-center justify-center gap-[0.1875rem] flex-1 @max-3xs:p-1">000<FontAwesomeIcon icon={faMessage} className="!h-[0.875rem]" /></p>
        </div>
        <div className="flex gap-2">
          <p className="tag flex justify-center flex-1 @max-3xs:p-1">#Tag</p>
          <p className="tag flex justify-center flex-1 @max-3xs:p-1">#Tag</p>
        </div>
      </div>
    </div>
